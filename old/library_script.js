$(document).ready(function() {
  ...
  var apiRoot = 'http://aqueous-taiga-18091.herokuapp.com/v1/library/';
  var datatableRowTemplate = $('[data-datatable-row-template]').children()[0];
  var readersContainer = $('[data-readers-container]');
  var titlesContainer = $('[data-titles-container]');
  var bookEntriesContainer = $('[data-bookEntries-container]');
  ...
  function createElement(data) {
    ...
    element.attr('data-title-id', data.id);
